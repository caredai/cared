...
export function Section({ children }: { children: ReactNode }) {
  return <div className="container max-w-7xl mx-auto py-4 px-4 sm:px-8 space-y-8">{children}</div>
}

export function SectionTitle({ title, description }: { title: string; description?: string }) {
  return (
    <div className="flex flex-col md:grid md:grid-cols-[min-content_min-content_max-content] md:items-center gap-x-4">
