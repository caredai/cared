...
import { useComposedRefs as useMergedRef } from '@radix-ui/react-compose-refs'
...
import type {
  ...
  OnLoadingComplete,
  PlaceholderValue,
} from '@/lib/image/get-img-props'
import type { ImageLoaderProps } from '@/lib/image/image-config'
import { env } from '@/env'
import { getImgProps } from '@/lib/image/get-img-props'
...
import defaultLoader from '@/lib/image/image-loader'
...
export const Image = forwardRef<HTMLImageElement | null, ImageProps>((props, forwardedRef) => {
  ...
  const { props: imgAttributes, meta: imgMeta } = getImgProps(props, {
    defaultLoader: config.loaderFn || defaultLoader,
    imgConf: config,
    blurComplete,
    showAltText,
  })
  ...
  return (
    <>
      ...
      {imgMeta.preload ? <ImagePreload imgAttributes={imgAttributes} /> : null}
    </>
  )
})
