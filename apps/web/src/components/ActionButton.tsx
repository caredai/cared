...
>(function ActionButton(
  ...
  const hasReachedLimit =
    typeof limit === 'number' && limitValue !== undefined && limitValue >= limit
  ...
  const getMessage = () => {
    ...
    if (hasReachedLimit && typeof limit === 'number') {
...
const ButtonContent = React.forwardRef<
  HTMLButtonElement,
  {
    ...
    className?: string
    buttonProps: Omit<ComponentProps<typeof Button>, 'disabled' | 'loading' | 'className'>
    children: React.ReactNode
    href?: string
  }
