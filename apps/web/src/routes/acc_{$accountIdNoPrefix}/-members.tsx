...
/**
 * Members component for account
 * Allows managing account members (remove, update roles) and invitations
 */
export function Members({ kind }: { kind: 'members' | 'invitations' }) {
  ...
  return (
    <>
      <SectionTitle title="Members" description="Manage members of your account" />
      ...
      <div className="flex flex-wrap justify-end items-center gap-2 mb-6">
        ...
        <Dialog open={isInviteDialogOpen} onOpenChange={setIsInviteDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Invite Account Member</DialogTitle>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove this member from the account? This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
