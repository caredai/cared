...
const updateAccountSchema = z.object({
  name: z
    ...
    .max(128, 'Account name cannot be longer than 128 characters'),
})

/**
 * Account settings component
 * Allows updating account name, transferring ownership, and deleting account
 */
function Settings() {
  ...
  const transferOwnership = useTransferAccountOwnership()

  // Form for updating account name
  const form = useForm({
  ...
  return (
    <>
      <SectionTitle title="Settings" description="Manage your account settings" />
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your account name. This will be visible to all members.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                ...
                {!isOwner && (
                  <p className="text-sm text-muted-foreground mt-2">
                    Only account owners can change the account name.
                  </p>
                )}
              </form>
            </Form>
        ...
        <Card>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    become a regular member of the account.
                  </DialogDescription>
                </DialogHeader>
                <div className="py-4">
                  <Select
          ...
          <CardFooter>
            {!isOwner && (
              <p className="text-sm text-muted-foreground">
                Only account owners can transfer ownership.
              </p>
            )}
          </CardFooter>
        </Card>
        ...
        <Card className="border-destructive/50">
            ...
            <div className="flex items-center justify-between rounded-lg border p-4">
              <div>
                ...
                <p className="text-sm text-amber-600 mt-1">
                  Account deletion is currently disabled for safety reasons.
                </p>
              </div>
          ...
          <CardFooter>
            {!isOwner && (
              <p className="text-sm text-muted-foreground">
                Only account owners can perform these actions.
              </p>
            )}
          </CardFooter>
        </Card>
