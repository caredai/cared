...
export const Route = createFileRoute('/user/api-tokens_/at_{$apiTokenIdNoPrefix}')({
  ...
  component: UserApiTokenDetailPage,
})

function UserApiTokenDetailPage() {
  const { apiTokenIdNoPrefix } = Route.useParams()
  const apiTokenId = addIdPrefix(apiTokenIdNoPrefix, 'at')

  return (
    <Suspense fallback={<SkeletonCard />}>
      <ApiTokenDetail apiTokenId={apiTokenId} credentialType="user" />
    </Suspense>
  )
}
