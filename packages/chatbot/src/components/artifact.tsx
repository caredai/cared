...
function PureArtifact({
    ...
    if (documents && documents.length > 0) {
      ...
      if (mostRecentDocument) {
        ...
        setArtifact((currentArtifact) => ({
          ...currentArtifact,
          content: mostRecentDocument.content as string,
        }))
      }
    }
  ...
  function getArtifactContentById(index: number) {
    ...
    return documents[index].content as string
  }
          ...
          >
            ...
            <div className="dark:bg-muted bg-background h-full overflow-y-scroll !max-w-full items-center">
              <artifactDefinition.content
                ...
                title={artifact.title}
                content={
                  isCurrentVersion ? artifact.content : getArtifactContentById(currentVersionIndex)
                }
                mode={mode}
                ...
                isInline={false}
                isCurrentVersion={isCurrentVersion}
                getArtifactContentById={getArtifactContentById}
