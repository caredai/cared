...
import type { IconBaseProps, IconData } from '@/base/icons/IconBase'
...
`.trim())
  ...
  await writeFile(path.resolve(currentPath, `${fileName}.module.css`), `${componentCSSRender({ assetPath: path.join('~@/base/icons/assets', ...pathList.slice(2), entry) })}\n`)
