...
import DialogWrapper from '@/base/features/new-feature-panel/dialog-wrapper'
import { useDefaultModel } from '@/app/components/header/account-setting/model-provider-page/hooks'
import { ModelTypeEnum } from '@/app/components/header/account-setting/model-provider-page/declarations'
import type { OnFeaturesChange } from '@/base/features/types'

import MoreLikeThis from '@/base/features/new-feature-panel/more-like-this'
import ConversationOpener from '@/base/features/new-feature-panel/conversation-opener'
import FollowUp from '@/base/features/new-feature-panel/follow-up'
import SpeechToText from '@/base/features/new-feature-panel/speech-to-text'
import TextToSpeech from '@/base/features/new-feature-panel/text-to-speech'
import FileUpload from '@/base/features/new-feature-panel/file-upload'
import Citation from '@/base/features/new-feature-panel/citation'
import ImageUpload from '@/base/features/new-feature-panel/image-upload'
import Moderation from '@/base/features/new-feature-panel/moderation'
import AnnotationReply from '@/base/features/new-feature-panel/annotation-reply'
