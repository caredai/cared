...
export interface FileListSizeProps extends React.ComponentPropsWithoutRef<'span'> {
  children: number
}

export const FileListSize = React.forwardRef<React.ElementRef<'span'>, FileListSizeProps>(
  ({ children, ...props }, ref) => (
    <span ref={ref} {...props}>
