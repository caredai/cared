...
const VirtualizedList = React.forwardRef<React.ElementRef<typeof VList>, VirtualizedListProps>(
  ({ orientation = 'vertical', ...props }, ref) => {
    ...
    return <VList ref={ref} horizontal={orientation === 'horizontal'} {...props} />
  },
)
...
>((props, ref) => {
  ...
  return <Virtualizer ref={ref} scrollRef={withScrollRef ? scrollRef : undefined} {...props} />
})
