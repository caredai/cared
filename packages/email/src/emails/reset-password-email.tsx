...
export default function ResetPasswordEmail({
  ...
  if (!link) {
    link = 'https://cared.dev/reset-password'
  }
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              We received a request to reset the password for your {app} account. If you made this
            ...
            <Section style={noticeContainer}>
              <Text style={noticeText}>
                <strong>Security Notice:</strong> This password reset link will expire in 1 hour for
                your security. If you didn't request a password reset from {app}, please contact our
                support team immediately as your account may be compromised.
              </Text>
            </Section>
          </Section>
